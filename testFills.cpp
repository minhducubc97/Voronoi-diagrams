...
TEST_CASE("colorPicker::basic dot", "[weight=1][part=colorPicker]")
{
  ...
  PNG expected;
  expected.readFromFile("soln_images/dotColorPickerTest.png");
...
TEST_CASE("colorPicker::basic fade", "[weight=1][part=colorPicker]")
{
  ...
  PNG expected;
  expected.readFromFile("soln_images/fadeColorPickerTest.png");
  REQUIRE(result == expected);
}
...
TEST_CASE("fill::basic dot dfs", "[weight=1][part=fill]")
{
  ...
  animation anim;
  anim =
      filler::vorDotDFS(img, DENSITY, GRIDGRIDSPACING, DOTSIZE, GRIDFRAMEFREQ);

  PNG result = anim.write("images/dfsdotleaf.gif");
  result.writeToFile("images/dfsdotleaf.png");
  PNG expected;
  expected.readFromFile("soln_images/dfsdotleaf.png");
  REQUIRE(result == expected);
}
...
TEST_CASE("fill::basic solid dfs", "[weight=1][part=fill]")
{
  ...
  PNG expected;
  expected.readFromFile("soln_images/dfssolidleaf.png");
  REQUIRE(result == expected);
}
...
TEST_CASE("fill::basic fade dfs", "[weight=1][part=fill]")
{
  ...
  anim = filler::vorFadeDFS(img, DENSITY, FADERATE, GRIDFRAMEFREQ);

  PNG result = anim.write("images/dfsfadeleaf.gif");
  result.writeToFile("images/dfsfadeleaf.png");
  PNG expected;
  expected.readFromFile("soln_images/dfsfadeleaf.png");
  REQUIRE(result == expected);
}
...
TEST_CASE("fill::basic dot bfs", "[weight=1][part=fill]")
{
  ...
  animation anim;
  anim =
      filler::vorDotBFS(img, DENSITY, GRIDGRIDSPACING, DOTSIZE, GRIDFRAMEFREQ);
  PNG result = anim.write("images/bfsdotleaf.gif");
  result.writeToFile("images/bfsdotleaf.png");
  PNG expected;
  expected.readFromFile("soln_images/bfsdotleaf.png");
  REQUIRE(result == expected);
}
...
TEST_CASE("fill::basic solid bfs", "[weight=1][part=fill]")
{
  ...
  PNG expected;
  expected.readFromFile("soln_images/bfssolidleaf.png");
  REQUIRE(result == expected);
}
...
TEST_CASE("fill::basic fade bfs", "[weight=1][part=fill]")
{
  ...
  anim = filler::vorFadeBFS(img, DENSITY, FADERATE, GRIDFRAMEFREQ);

  PNG result = anim.write("images/bfsfadeleaf.gif");
  result.writeToFile("images/bfsfadeleaf.png");
  PNG expected;
  expected.readFromFile("soln_images/bfsfadeleaf.png");
  REQUIRE(result == expected);
}
