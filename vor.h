 ...
 * @return An animation that shows the fill progressing over the image.
 */
animation vorFadeDFS(PNG& img, double density, double fadeFactor,
                     int frameFreq);
 ...
 * @return An animation that shows the fill progressing over the image.
 */
animation vorFadeBFS(PNG& img, double density, double fadeFactor,
                     int frameFreq);
 ...
 * @return An animation that shows the fill progressing over the image.
 */
animation vorDotDFS(PNG& img, double density, int dotGrid, int dotSize,
                    int frameFreq);
 ...
 * @return An animation that shows the fill progressing over the image.
 */
animation vorDotBFS(PNG& img, double density, int dotGrid, int dotSize,
                    int frameFreq);
...
point processPixel(int x, int y, center c, int level, PNG& img, int frameFreq,
                   animation& imgAnimation, colorPicker& fillColor,
                   int& noPixelFilled);
